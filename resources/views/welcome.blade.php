...
<div class=" barner-Accueil1 ">
    <div class="row">
        @include('layout.courousel')
           <a href="{{ route('Contacts') }}" class="btn btnb w-50 cont">Nous contacter</a>
...
<div class="container barniere-2 solution">
    <div class="row">
        ...
        <div class="col-sm-12 col-md-6 col-lg-3">
            <a href="{{ route('Application-web') }}" class="a">
                <div class="nosulutions"data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
        ...
        <div class="col-sm-12 col-md-6 col-lg-3 " >
            <a href="{{ route('Application-mobile') }}" class="a">
                <div class="nosulutions "data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
...
<div class="container-fluid solution" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
    <div class="row">
        <div class="col-sm-12 col-md-2 col-lg-2"></div>
        <div class="col-sm-12 col-md-8 col-lg-8">
            <h3 class="kanit-semibold titre-principal" style="text-align: center">Témoignages des nos clients</h3>
            <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <img class="img" src="{{ asset('img/temo1.jpg') }}" alt="">
                        </div>
                  ...
                  <div class="carousel-item">
                        ...
                        <h5 class="titre-secondaire">PDG de Sauvons le Congo</h5>
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                <img class="img" src="{{ asset('img/temo2.jpg') }}" alt="">
                            </div>
                            <div class="col-sm-12 col-md-6 col-lg-6" style="text-align:justify">
                  ...
                  <div class="carousel-item">
                    ...
                    <h5 class="titre-secondaire">PDG de Sauvons le Congo</h5>
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <img class="img" src="{{ asset('img/temo3.jpg') }}" alt="">
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6" style="text-align:justify">
