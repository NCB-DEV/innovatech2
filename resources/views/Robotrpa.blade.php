...
@section('siteweb')
    <div class=" solution aproposl">
        ...
        <h1 class="indie-flower-regular position-text-centre ban2">Robot RPA</h1>

    </div>
    <div class="container " data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
        <div class="row">
            <div class="col-sm-12 md-6 col-lg-6">
                <h2  class="text-couleur-orange" >automatiser vos tâches pour booster votre productivité</h2>
            ...
            <div class="col-sm-12 md-6 col-lg-6 solu">
                <img  src="{{ asset('img/robot-30659.svg') }}" class="img robo" alt="">
            </div>
        </div>
    </div>
    <div class="container solu" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
        <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-6">
                <img class="img kkk" src="{{ asset('img/robot-2027195_1920.png') }}" alt="">
            </div>
            <div class="col-sm-12 col-md-6 col-lg-6 text">
                <h3 class="text-couleur-orange">Avantages des robots RPA</h3>
                <p class="text-couleur-blue">
