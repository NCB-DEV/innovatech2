<div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item">
        ...
        <div class="carousel-caption  d-md-block">
            <h1 style="position: relative; bottom:250px;right:35%;font-weight:bold; color:black; font-size:5em"> InnovaTech</h1>
          <p style="position: relative;  bottom:250px;right:10%; color:black;width:50%; font-size:2em;text-align:center">  le choix de l'expertise, de la performance et de la confiance.<p>
        </div>
      </div>
    </div>
